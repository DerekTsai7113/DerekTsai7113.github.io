...
title: Research
permalink: /projects/
description: Selected research in statistical machine learning, biomedical data science, neural representation learning, and reliable prediction.
nav: true
nav_order: 1
horizontal: false
---
...
I study how representations learned by pretrained speech and language models correspond to human neural responses measured with EEG and fMRI, with an emphasis on layer-wise neural encoding and clean-versus-noisy speech comparisons.
...
<p class="research-meta">Academia Sinica · Ongoing Research Collaboration</p>

This collaboration examines whether speech-related information can be decoded from fMRI across noisy and speech-enhanced listening conditions. I contribute to model development, ROI-wise evaluation, baseline comparisons, reproducible analysis, and statistical testing.
...
<p class="research-meta">University of Washington · Graduate Research Project</p>
